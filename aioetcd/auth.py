...
from ._rpc import auth_pb2, rpc_pb2, rpc_pb2_grpc
...
class EnableResponse:
    ...
    @classmethod
    def from_protobuf(cls, pb_value: rpc_pb2.AuthEnableResponse) -> EnableResponse:
...
class DisableResponse:
    ...
    @classmethod
    def from_protobuf(cls, pb_value: rpc_pb2.AuthDisableResponse) -> DisableResponse:
...
class UserAddResponse:
    ...
    @classmethod
    def from_protobuf(cls, pb_value: rpc_pb2.AuthUserAddResponse) -> UserAddResponse:
...
class UserGetResponse:
    ...
    @classmethod
    def from_protobuf(cls, pb_value: rpc_pb2.AuthUserGetResponse) -> UserGetResponse:
...
class AuthApi:
    ...
    async def enable(self) -> EnableResponse:
        ...
        response = await self._auth_stub.AuthEnable(rpc_pb2.AuthEnableRequest())
        return EnableResponse.from_protobuf(response)

    async def disable(self) -> DisableResponse:
        """disables authentication."""
        response = await self._auth_stub.AuthDisable(rpc_pb2.AuthDisableRequest())
    ...
    async def user_add(self, name: str, password: str) -> UserAddResponse:
        ...
        response = await self._auth_stub.UserAdd(
            rpc_pb2.AuthUserAddRequest(name=name, password=password, options=options)
        )
    ...
    async def user_get(self, name: str) -> UserGetResponse:
        ...
        response = await self._auth_stub.UserGet(rpc_pb2.AuthUserGetRequest(name=name))
