...
_PERMISSION_TYPE = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="READ", index=0, number=0, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="WRITE", index=1, number=1, serialized_options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="READWRITE",
            index=2,
...
_USERADDOPTIONS = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="no_password",
            full_name="authpb.UserAddOptions.no_password",
            index=0,
            number=1,
            type=8,
            cpp_type=7,
...
UserAddOptions = _reflection.GeneratedProtocolMessageType(
    "UserAddOptions",
    (_message.Message,),
    {
