...
from grpc.aio import ClientCallDetails  # type: ignore
from grpc.aio import StreamStreamClientInterceptor, UnaryUnaryClientInterceptor
from grpc.aio._call import (
    StreamStreamCall,
    UnaryStreamCall,  # type: ignore
    UnaryUnaryCall,
)
from grpc.aio._typing import (
    RequestIterableType,
    RequestType,  # type: ignore
...
class AuthInterceptor(
    ...
    def __init__(
        ...
        self._metadata: typing.Optional[typing.Tuple[typing.Tuple[str, str]]] = None
